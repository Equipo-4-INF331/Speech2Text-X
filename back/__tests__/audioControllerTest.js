...
describe('Audio Controller', () => {
  ...
  const req = {
    query: {
      name: 'El que se fue a milipilla',
      description: 'El que se fue a milipilla perdio su silla',
      dateFrom: new Date('2025-10-16T20:00:00Z'),
      dateTo: new Date('2025-10-17T20:00:00Z'),
    },
    user: { username: 'pepe' },
  };
  ...
  it('debería filtrar audios solo por name', async () => {
    ...
    const req = { query:{ name: "El que se fue a milipilla" }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios solo por description', async () => {
    ...
    const req = { query:{ description: "El que se fue a milipilla perdio su silla" }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios solo por dateFrom', async () => {
    ...
    const req = { query:{ dateFrom: new Date('2025-10-16T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios solo por dateTo', async () => {
    ...
    const req = { query:{ dateTo: new Date('2025-10-17T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios por name y description', async () => {
    ...
    const req = { query:{ name: "El que se fue a milipilla", description: "El que se fue a milipilla perdio su silla" }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios por name y dateFrom', async () => {
    ...
    const req = { query:{ name: "El que se fue a milipilla", dateFrom: new Date('2025-10-16T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios por name y dateTo', async () => {
    ...
    const req = { query:{ name: "El que se fue a milipilla", dateTo: new Date('2025-10-17T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios por description y dateFrom', async () => {
    ...
    const req = { query:{ description: "El que se fue a milipilla perdio su silla", dateFrom: new Date('2025-10-16T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios por description y dateTo', async () => {
    ...
    const req = { query:{ description: "El que se fue a milipilla perdio su silla", dateTo: new Date('2025-10-17T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
  ...
  it('debería filtrar audios por dateFrom y dateTo', async () => {
    ...
    const req = { query:{ dateFrom: new Date('2025-10-16T20:00:00Z'), dateTo: new Date('2025-10-17T20:00:00Z') }, user: {username: 'pepe'} };
    await filterAudios(req, res);
    expect(res.status).toHaveBeenCalledWith(200);
    expect(res.set).toHaveBeenCalledWith('Cache-Control', 'no-cache');
    expect(res.json).toHaveBeenCalledWith({ success: true, data:[{ id: 1, username: 'pepe', name:'El que se fue a milipilla',audio:'link',transcription:'El que se fue a milipilla perdio su silla',created_at: new Date('2025-10-17T20:00:00Z'), url: 'https://signed-url.com' }]});
